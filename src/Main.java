...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        Sparkonto spar1 = new Sparkonto("22222222", 5.0D, 0.0D, null, null, 'p', LocalDate.of(2021, 1, 2), 0.0D);
        spar1.eroeffnen(kunde2, 1.0D);
        spar1.einzahlen(2850.0D, LocalDate.of(2021, 2, 11));
        spar1.zinsenBerechnen(LocalDate.of(2022, 1, 01));
        spar1.zinsenBerechnen(LocalDate.of(2023, 1, 01));

        // Giro 1

        Girokonto giro1 = new Girokonto("50060080", 1.5D, 0.0D, null, null, 7.5D, 3000.0D, LocalDate.of(2021, 2, 10), 0.0D);
        ...
        giro1.zinsenBerechnen(LocalDate.of(2022, 1, 01));
        giro1.zinsenBerechnen(LocalDate.of(2022, 4, 01));
        giro1.zinsenBerechnen(LocalDate.of(2022, 7, 01));
        giro1.zinsenBerechnen(LocalDate.of(2022, 10, 01));
        giro1.zinsenBerechnen(LocalDate.of(2023, 01, 01));


        // Giro 2

        Girokonto giro2 = new Girokonto("50060090", 1.5D, 0.0D,null, null, 7.5D, 2000.0D, LocalDate.of(2021, 1, 2), 0.0D);
        ...
        giro2.zinsenBerechnen(LocalDate.of(2022, 1, 01));
        giro2.zinsenBerechnen(LocalDate.of(2022, 4, 01));
        giro2.zinsenBerechnen(LocalDate.of(2022, 7, 01));
        giro2.zinsenBerechnen(LocalDate.of(2022, 10, 01));
        giro2.zinsenBerechnen(LocalDate.of(2023, 01, 01));
